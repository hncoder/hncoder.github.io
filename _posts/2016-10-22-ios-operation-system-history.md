...
iOS是苹果开发的移动智能设备操作系统，这个作为开发者无人不知，但对于早年的版本变化，可能不是每个人都去了解过。比如说，它早在苹果发布iPhone SDK（2008年3月6日发布）之前的1.x版本是没有正式名称的，当年，苹果对外宣称iPhone是运行在桌面系统OS X的某个版本上。随着版本2.0的发布，系统才取名为iPhone OS。之后经历了几个版本，并且直到运行在第一代iPad的3.2版本发布才更名为iOS。了解iOS历史版本时间线，可以查看以下表格。
